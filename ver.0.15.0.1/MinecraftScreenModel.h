...
class MinecraftScreenModel{
	public:
		...
		void function<void ();
		void function<void ();
		void getRealmsShowFriendInvitesOnly(void);
		void getRealmsShowFriendInvitesOnly(void);
		void function<void ();
		void function<void ();
		...
		void getSkinSerializableName(MinecraftScreenModel::SkinInfo const&);
		void getStoreHasRealmsProducts(void);
		void getStoreHasRealmsProducts(void);
		...
		void navigateToRealmsSettingsScreen(Realms::World const&);
		void navigateToRealmsWorldProgressScreen(std::string const&,std::string const&,std::unique_ptr<ProgressHandler,std::default_delete<ProgressHandler>>,bool);
		void navigateToRealmsWorldProgressScreen(std::string const&,std::string const&,std::unique_ptr<ProgressHandler,std::default_delete<ProgressHandler>>,bool);
