...
class ServerNetworkHandler{
	public:
		ServerNetworkHandler(GameCallbacks &,Level &,GameMode *,NetworkHandler &,PrivateKeyManager &,ServerLocator &,PacketSender &,SkinInfoFactory &,Whitelist const&,Player *,int,bool,std::string,int);
		ServerNetworkHandler(GameCallbacks &,Level &,GameMode *,NetworkHandler &,PrivateKeyManager &,ServerLocator &,PacketSender &,SkinInfoFactory &,Whitelist const&,Player *,int,bool,std::string,int);
