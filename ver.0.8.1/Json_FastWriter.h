...
namespace Json{
	class FastWriter{
		...
		void ErrorInfo(Json::Reader::ErrorInfo const&);
		...
		void getLocationLineAndColumn(char const*);
		...
		void valueToQuotedString(char const*);
		void valueToString(bool);
		void valueToString(double);
		void valueToString(int);
		void valueToString(long long);
		void valueToString(uint);
		void valueToString(ulong long);
	}
};
