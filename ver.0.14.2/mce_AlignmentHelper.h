...
namespace mce{
	class AlignmentHelper{
		...
		void ~BufferOGL();
		void createConstantBuffer(mce::RenderContext &,uint);
		...
		void EnableScissorTest(float,float,float,float);
		...
		void createFrameBufferAttachment(mce::RenderContext &,mce::Texture &&);
		...
		void createFrameBufferAttachment(mce::RenderContext &,mce::FrameBufferAttachmentDescription const&,mce::Texture &&);
		...
		void init(void);
		void setShaderAtlasFaceSize(glm::detail::tvec2<float> const&);
		...
		void _getTexture(std::string const&,TextureLocation);
		...
		void isLoaded(std::string const&);
		...
		void unlock(mce::RenderContext &);
		void ~TextureOGL();
		void TexturePtr(mce::TextureGroup &,std::string const&,TextureLocation);
		...
		void _isMipmap(std::string const&);
		void _mipTagStart(std::string const&);
