...
class MinecraftInputMappingFactory{
	public:
		MinecraftInputMappingFactory(void);
		...
		void _addSharedGamePlayGamePadControls(GamePadInputMapping &);
		void _bindActionToInput(GamePadInputMapping &,std::string const&,int,float);
		void _configureGamepadMapping(GamePadInputMapping &);
		void _createBedKeyboardMapping(void);
		void _createBedTestAutoInputMapping(void);
		void _createBoatGamePadMapping(void);
		void _createBoatKeyboardMapping(void);
		void _createBoatTestAutoInputMapping(void);
		...
		void _createNormalGamePlayTestAutoInputMapping(void);
		...
		void _createScreenTestAutoInputMapping(void);
