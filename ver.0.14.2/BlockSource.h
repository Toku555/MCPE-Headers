...
class BlockSource{
	public:
		...
		void neighborChanged(BlockPos const&,BlockPos const&,BlockID);
		...
		void updateNeighborsAt(BlockPos const&,BlockPos const&,BlockID);
		void updateNeighborsAtExceptFromFacing(BlockPos const&,BlockPos const&,BlockID,int);
		void ~BlockSource();
		void ~BlockSource();
};
