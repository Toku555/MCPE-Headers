...
class FishingHook{
	public:
		...
		FishingHook(BlockSource &,EntityUniqueID,ItemInstance const*);
		FishingHook(BlockSource &,EntityUniqueID,Vec3 const&,ItemInstance const*);
		...
		void _hitCheck(void);
		void _init(EntityUniqueID,ItemInstance const*);
